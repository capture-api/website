...
const codeExamples = [
  {
    label: "cURL",
    code: `curl "https://api.captureapi.net/screenshot?url=
      https://example.com&api_key=YOUR_API_KEY&
      width=1920&height=1080"-o screenshot.png`,
  },
  {
    label: "JavaScript",
    code: `const url = "https://api.captureapi.net/screenshot?url=
      https://example.com&api_key=YOUR_API_KEY";
...
response = requests.get("https://api.captureapi.net/screenshot", 
              params=params)
...
const features = [
  {
    ...
    description: "Capture screenshots with a single HTTP request.",
  },
  {
    title: "Full Page Capture",
    description: "Render entire webpages including dynamic content.",
  },
  {
    title: "Multiple Formats",
    description: "Export screenshots as PNG, JPG, or PDF.",
  },
  {
    title: "Fast Rendering",
    description: "Generate screenshots in under a second.",
  },
];
...
Integrate in seconds using Node.js, Python, cURL, or any HTTP client.
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-6 text-sm">
              ...
              <a href="https://github.com/capture-api" target="_blank" rel="noopener noreferrer nofollow" className="text-muted-foreground hover:text-foreground">
                View on GitHub
              </a>
            </div>
          </div>
