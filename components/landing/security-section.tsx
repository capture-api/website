...
const securityFeatures = [
  {
    ...
    description: "All API requests require secure API keys to prevent unauthorized access.",
  },
  {
    icon: Lock,
    title: "Encrypted Requests",
    description: "All traffic is protected using HTTPS and TLS encryption.",
  },
  {
    icon: Eye,
    title: "Isolated Browser Rendering",
    description: "Screenshots are generated in sandboxed browser environments for safety.",
  },
  {
    icon: FileCheck,
    title: "Privacy First",
    description: "Screenshots are processed securely and never shared with third parties.",
  },
];
